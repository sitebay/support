...
def exit_script(custom_message):
    print(custom_message)
    print()
    print("usage: mv-tutorial.py source target")
    print("       mv-tutorial.py source ... directory")
    print("source and directory arguments must be directories.")
    print()
    print("This command can:")
    print("- Rename the path of a tutorial or section.")
    print(
        "- Move several tutorials or sections to another section that already exists."
    )
    print(
        "The command will add aliases from your tutorials' and sections' old locations, \nand it will stage all changes when finished."
    )
    sys.exit(1)
...
move_tutorials(sys.argv[1:])

print("All tutorials moved successfully, and changes have been staged.")
print("Run 'git status' and 'git diff --staged' to review changes.")
print(
    "This command does not update the titles of your tutorials, please remember to do so if appropriate."
)
