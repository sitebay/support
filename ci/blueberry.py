...
BASE_URL = "http://localhost:1313/support/"
...
INTERNAL_LINK_REGEX = re.compile(r'\[(.*)\]\((/support/[^")]*)(\".*\")?\)')
...
def find_files(path=".", ignore_paths=[], extensions=["MD", "md"], recursive=False):
    ...
    if ignore_paths:
        ...
        # ['/home/travis/build/sitebay/support/ignored_dir1/', '/home/travis/build/sitebay/support/ignored_dir2']
